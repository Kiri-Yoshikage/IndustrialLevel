...
public class PlatinumArmor extends ArmorItem {
    public PlatinumArmor(EquipmentSlot pSlot) {
        super(ILArmorMaterial.PLATINUM, pSlot, new Properties().tab(ModSetup.CLASSIC_TAB));
    }
    ...
    public String getArmorTexture(ItemStack itemstack, Entity entity, EquipmentSlot slot, String layer) {
        if (slot == EquipmentSlot.LEGS) {
            return IndustrialLevel.ModId + ":textures/armor/platinum/2.png";
        } else {
            return IndustrialLevel.ModId + ":textures/armor/platinum/1.png";
        }
    }
}