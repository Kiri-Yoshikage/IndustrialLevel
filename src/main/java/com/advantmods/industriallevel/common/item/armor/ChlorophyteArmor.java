...
public class ChlorophyteArmor extends ArmorItem {
    public ChlorophyteArmor(EquipmentSlot pSlot) {
        super(ILArmorMaterial.CHLOROPHYTE, pSlot, new Properties().tab(ModSetup.CLASSIC_TAB));
    }
    ...
    public String getArmorTexture(ItemStack itemstack, Entity entity, EquipmentSlot slot, String layer) {
        if (slot == EquipmentSlot.LEGS) {
            return IndustrialLevel.ModId + ":textures/armor/chlorophyte/2.png";
        } else {
            return IndustrialLevel.ModId + ":textures/armor/chlorophyte/1.png";
        }
    }
}