...
public class TitaniumArmor extends ArmorItem {
    public TitaniumArmor(EquipmentSlot pSlot) {
        super(ILArmorMaterial.TITANIUM, pSlot, new Properties().tab(ModSetup.CLASSIC_TAB));
    }
    ...
    public String getArmorTexture(ItemStack itemstack, Entity entity, EquipmentSlot slot, String layer) {
        if (slot == EquipmentSlot.LEGS) {
            return IndustrialLevel.ModId + ":textures/armor/titanium/2.png";
        } else {
            return IndustrialLevel.ModId + ":textures/armor/titanium/1.png";
        }
    }
}