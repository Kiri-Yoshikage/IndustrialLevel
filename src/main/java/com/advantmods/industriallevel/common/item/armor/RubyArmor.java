...
public class RubyArmor extends ArmorItem {
    public RubyArmor(EquipmentSlot pSlot) {
        super(ILArmorMaterial.RUBY, pSlot, new Properties().tab(ModSetup.CLASSIC_TAB));
    }
    ...
    public String getArmorTexture(ItemStack itemstack, Entity entity, EquipmentSlot slot, String layer) {
        if (slot == EquipmentSlot.LEGS) {
            return IndustrialLevel.ModId + ":textures/armor/ruby/2.png";
        } else {
            return IndustrialLevel.ModId + ":textures/armor/ruby/1.png";
        }
    }
}