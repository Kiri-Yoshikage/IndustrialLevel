...
public class TinArmor extends ArmorItem {
    public TinArmor(EquipmentSlot pSlot) {
        super(ILArmorMaterial.TIN, pSlot, new Properties().tab(ModSetup.CLASSIC_TAB));
    }
    ...
    public String getArmorTexture(ItemStack itemstack, Entity entity, EquipmentSlot slot, String layer) {
        if (slot == EquipmentSlot.LEGS) {
            return IndustrialLevel.ModId + ":textures/armor/tin/2.png";
        } else {
            return IndustrialLevel.ModId + ":textures/armor/tin/1.png";
        }
    }
}