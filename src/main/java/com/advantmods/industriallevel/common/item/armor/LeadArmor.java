...
public class LeadArmor extends ArmorItem {
    public LeadArmor(EquipmentSlot pSlot) {
        super(ILArmorMaterial.LEAD, pSlot, new Properties().tab(ModSetup.CLASSIC_TAB));
    }
    ...
    public String getArmorTexture(ItemStack itemstack, Entity entity, EquipmentSlot slot, String layer) {
        if (slot == EquipmentSlot.LEGS) {
            return IndustrialLevel.ModId + ":textures/armor/lead/2.png";
        } else {
            return IndustrialLevel.ModId + ":textures/armor/lead/1.png";
        }
    }
}